...
class Demo(nn.Module):
    ...
    def cal_c_loss(self, users, bundles, users_feat, bundles_feat):
        ...
        aff_pos_logits = torch.sum(users_feat[batch_users] * bundles_feat[0][bundles[:, 0]], 1)
        aff_neg_logits = torch.sum(users_feat[batch_users] * bundles_feat[0][bundles[:, 1]], 1)
        ...
        hist_pos_logits = torch.sum(users_feat[batch_users] * bundles_feat[1][bundles[:, 0]], 1)
        hist_neg_logits = torch.sum(users_feat[batch_users] * bundles_feat[1][bundles[:, 1]], 1)
